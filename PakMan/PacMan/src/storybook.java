...
class storybook {
    ...
    Text storybookLabel2 = new Text("\n                      A group of coders were creating PakMan. One of the coders allowed their\n" +
    ...
    public void setStorybook() {
        ...
        Font largeFont = Font.loadFont("file:PacMan/Resources/Font/fairytale.ttf", 50);
        Font smallFont = Font.loadFont("file:PacMan/Resources/Font/fairytale.ttf", 35);
